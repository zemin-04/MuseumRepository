...
public class Culturalrelics {
    ...
    public void setCulturalrelicsName(String culturalrelicsName) {
        this.culturalrelicsName = culturalrelicsName == null ? null : culturalrelicsName.trim();
    }
    ...
    public void setCulturalrelicsNumber(String culturalrelicsNumber) {
        this.culturalrelicsNumber = culturalrelicsNumber == null ? null : culturalrelicsNumber.trim();
    }
    ...
    public void setCulturalrelicsIntroduction(String culturalrelicsIntroduction) {
        this.culturalrelicsIntroduction = culturalrelicsIntroduction == null ? null : culturalrelicsIntroduction.trim();
    }
    ...
    public void setCulturalrelicsImageurl(String culturalrelicsImageurl) {
        this.culturalrelicsImageurl = culturalrelicsImageurl == null ? null : culturalrelicsImageurl.trim();
    }
    ...
    public void setCulturalrelicsMusicurl(String culturalrelicsMusicurl) {
        this.culturalrelicsMusicurl = culturalrelicsMusicurl == null ? null : culturalrelicsMusicurl.trim();
    }
